...
export const siteConfig: SiteConfig = {
  title: "Stinger",
  subtitle: "Mohamed Goudam's Personal Blog",
  siteURL: "https://mohamed-goodv.github.io/", // 请替换为你的站点URL，以斜杠结尾
  ...
  navbarTitle: {
    ...
    icon: "assets/home/image.jpeg",
    // 网站Logo图片路径
    logo: "assets/home/image.jpeg",
  },
  ...
  banner: {
    ...
    src: {
      desktop: ["/assets/desktop-banner/4.webp"], // 桌面横幅图片
      mobile: ["/assets/desktop-banner/4.webp"], // 移动横幅图片
    }, // 使用本地横幅图片
    ...
    homeText: {
      ...
      title: "Stinger", // 主页横幅主标题

      subtitle: ["Every bug is a story waiting to be told"],
      typewriter: {
